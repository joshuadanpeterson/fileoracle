...
def answer_query_from_files(
    ...
    :param vector_store_id: The hosted vector store ID (required if use_responses_api is True).
    :return: The answer generated by the LLM with citations, or an API response object.
    """
    if use_responses_api and vector_store_id:
        print("Using OpenAI's Responses API for file search and answer generation...")
